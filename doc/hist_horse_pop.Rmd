...
```{r plot horses, fig.width=10, fig.height=3, fig.cap = "Figure 1: Number of hourses per province in Canada between 1906 to 1972", out.width = "100%"}
...
kable(max_horses, caption = "Table 1. This is a summary of the data set")
```

Below we zoom in and look at the province of `r params$province`:

```{r plot province, fig.width=5, fig.height=4, fig.cap = "Figure 2: Number of horses for province our focus", out.width = "50%"}
